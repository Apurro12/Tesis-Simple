...
Quedandome solo con el orden domintante obtengo para la ecuacion (\ref{eq.aprox}) %, definiendo las variables adimensionales $\mu = \omega L$, $\beta = \alpha L $, obtengo para la ecuación  (\ref{eq.aprox}):. 
...
Los primeros dos polos son de la forma:
...
\left(
	- \frac{3 \alpha (-1 + L \alpha) }{16 L ^2 \pi } + \frac{\alpha ^3 \psi ^2 (1)}{32 \pi}
\right)
\frac{1}{s+ 3/2} + Regular \\
\zeta _A (s \rightarrow - 5/2 ) = 
\left(
- \frac{5 \alpha (18 - 17 L \alpha + 3 L ^2 \alpha ^2)}{192 L ^4 \pi} +
\frac{\alpha ^5 \zeta (5) }{64 \pi }
\right)
\frac{1}{s+ 5/2} + Regular
\end{array}
\end{equation}
