...
Al igual que antes, cuando integre sobre los ejes verticales voy a tener una parte exponencialmente creciente/decreciente, tirando estos términos los Lnaritmos quedan (salvo constantes aditivas):

\begin{equation}
\begin{array}{c}

Ln ( M ( \lambda = i t ) ) =  Ln(S2) + 
\frac{i \alpha Ln(2 \lambda L)}{2 \lambda} - Ln( \Gamma( 1 + \frac{i \alpha}{2 \lambda} ) ) \\

Ln( M ( \lambda = -i t ) ) = 2 i \lambda L - \frac{i \alpha Ln( 2 \lambda L )}{2 \lambda} - 
Ln( \Gamma ( 1 - \frac{i \alpha}{2 \lambda} )) + Ln(S1)

\end{array}
\end{equation}

Donde lo único que difiere los Lnaritmos calculados antes, es la suma de los términos $S1$ y $S2$.
...
%, y las contribuciones a la parte finita en $s=-1/2$ estan dadas por el desarrollo en serie de la funcion Polygamma mas las derivadas Lnaritmicas de las correcciones asintoticas.
...
En vez de desarrollar en serie $S'(t) /S$ voy a desarrollar el Lnaritmo y tomarle la derivada:
...
Si yo quiero cortar la serie $\sum \frac{S _n}{\lambda ^n}$ en la potencia $\lambda ^{-N}$, el Lnaritmo voy a tener que desarrollarlo hasta la potencia $N$ para sumar todos los términos $\lambda ^{-N}$.

La primer serie me contribuye hasta la potencia $\lambda ^{-N}$, entonces tengo que sumar todos los términos que contribuyan con esa potencia, el ultimo termino que contribuye es $m=N$, entonces puedo cortar ambas series en $N$ y estar seguro que el desarrollo del Lnaritmo es correcto hasta la potencia $\lambda ^{-N}$.
