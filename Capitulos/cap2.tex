...
Lo cual conduce a una Energía de Vacío atractiva. \\
...
Tal como se puede ver en la figura [\ref{fig:Dibujo1}], los autovalores $\mu _n$ tienden a pegarse a la asíntota vertical de $ Tg ( \mu ) $ a medida que $\mu _n$ se hace cada vez mas grande.
...
Conocida la ecuación de autovalores, se puede proceder a calcular la función $\zeta _A (s) $ sin calcular explícitamente los autovalores, utilizando variable compleja.
...
Donde puede utilizarse como camino de integración cualquiera de los dos caminos representados en la figura [\ref{fig:contorno}], dado que la función $f'(z) / f(z) $ tiene polos en los autovalores de $\hat{A}$.
