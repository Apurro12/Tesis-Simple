...
\textbf{Dirichlet y Periódicas}

El operador $A$ tendrá las siguientes condiciones de contorno, segun sea Dirichlet o Neumann : 
...
La funcion $\zeta _A (s)$ de ambos operadores quedará determinada por:
...
\textbf{Energías de Vacío }

Como ninguna de las $\zeta _A (s)$ tiene polos para obtener la energía de vacío voy a evualuar $\zeta (s)$ en $s = -1/2$
...
\begin{equation}
\begin{array}{c}
E _0 = - \frac{\pi}{12 L}, Dirichlet \ y \ Neumann \\
E _0 = - \frac{\pi}{6 L} , Periodicas \\
\end{array}
\end{equation}
...
\zeta (s \rightarrow -n + 1/2)  = \frac{ (-1) ^n L ^{2n-1}  }{\pi} \frac{1}{s- n + 1/2}
