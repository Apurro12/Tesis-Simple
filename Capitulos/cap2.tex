...
Dado que la función $f'(z) / f(z) $ tiene polos en los autovalores de $\hat{A}$, la función $\zeta _A (s)$ puede representarse como una integral en el plano complejo, donde el camino de intregración es cualquiera de los dos caminos representados en la figura [\ref{fig:contorno}].
