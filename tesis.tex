...
%\includeonly{Capitulos/cap3,Capitulos/cap2}
...
{\red En este trabajo de tesis se estudiara la funcion zeta en el intervalo compacto $[0,L]$ del operador singular $A = - \partial _x ^2 + \frac{\alpha}{x} $, está inspirado en un trabajo realizado por A. Wipf, P. A. G. Pisani y  H. Falomir \cite{0305-4470-35-26-306}, en donde se estudian las funciones espectrales de operadores del estilo $A = - \partial _x ^2 + \frac{g}{x ^2} + x^2 $ el cual posee simetría conforme.}
...
\addtocontents{toc}{\vspace{2exm}} % Agrega espacio en la toc
