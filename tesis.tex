...
%\includeonly{Apendices/ApB}%Capitulos/cap3}
...
En este trabajo de tesis se estudió la {\it función-$\zeta$} del operador ${A = - \partial ^2 _x + \frac{\alpha}{x}}$ en el intervalo compacto $[0,L]$ encontrando que a diferencia del operador anterior polos se ubican según $s _n = \frac{1 - n}{2}$ como habria de esperarse en el caso regular, pero a diferencia de este la singularidad conduce a la aparición de un polo doble en el momento de calcular la energía de vacío, lo cual implica que el desarrollo del {\it heat-kernel} posee términos logaritmicos. Tal como se conjeturó en 1980 por Constantine Callias y Clifford H. Taubes \cite{callias1980}.
...
\include{Apendices/ApB}
\include{Apendices/ApC}
\thispagestyle{empty}
