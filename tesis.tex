...
En este trabajo de tesis se estudió la {\it función-$\zeta$} de un operador singular en un intervalo compacto, encontrando que los polos se ubican como habría de esperarse en el caso regular, pero con la aparición de un polo doble; lo cual implica que el desarrollo del {\it heat-kernel} posee términos logarítmicos tal como se conjeturó en 1980, por Constantine Callias y Clifford H. Taubes \cite{callias1980}.
